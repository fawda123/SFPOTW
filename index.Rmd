...
potwmap <- reactive({
  ...
  out <- leaflet() %>%
    ...
    addCircleMarkers(data = locs, lng = ~lon, lat = ~lat, radius = 5, color = 'black', fillOpacity = 0.8, popup = ~paste0('<b>POTW: </b>', POTW))
...
output$potwmap <- renderLeaflet(potwmap())
