...
potwplo <- reactive({
  ...
  plo_fun(potwseldat, sumsel1, yearsel1, barsel = F)  
...
submplot <- reactive({
  ...
  plo_fun(submseldat, sumsel2, yearsel2, barsel2)
...
Questions and comments about the dashboard can be sent to [David Senn](mailto:davids@sfei.org) or [Marcus Beck](mailto:mbeck@tbep.org). The website source content can be viewed on [Github](https://github.com/fawda123/SFPOTW).
