...
mos <- seq.Date(as.Date('2022-01-01'), as.Date('2022-12-31'), by = 'month')
```
    ...
    column(6, renderUI({
      ...
      if(sumsel1){
        tags$div(title = "Select the annual range of interest", 
          sliderInput("yearsel1", "Month range", min = mos[1], max = mos[12], value = range(mos), timeFormat = '%b', width = '100%'))
      }
...
fillCol(flex = c(NA, NA, 1), 
  ...
  column(12,
    ...
    column(6, renderUI({
      ...
      if(sumsel2){
        tags$div(title = "Select the annual range of interest", 
          sliderInput("yearsel2", "Month range", min = mos[1], max = mos[12], value = range(mos), timeFormat = '%b', width = '100%'))
      }
